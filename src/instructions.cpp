...
void Instruction::apply_unitary(Matrix& U, StateVector& statevector, std::vector<int> qubits)
{
...
meas_out Instruction::apply_measure(StateVector& statevector, std::vector<int> qubits)
{
    return cunqa_apply_measure(statevector, qubits);
}

void Instruction::apply_instruction(StateVector& statevector, std::string instruction_name, std::vector<int> qubits)
{
...
//Parametric
void Instruction::apply_param_instruction(StateVector& statevector, std::string instruction_name, std::vector<int> qubits, Params& param)
{
    switch (instructions_map[instruction_name])
    {
    case rx:
